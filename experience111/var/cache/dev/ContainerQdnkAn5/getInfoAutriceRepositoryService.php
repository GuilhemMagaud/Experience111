 ...
 */
class getInfoAutriceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InfoAutriceRepository' shared autowired service.
     *
     * @return \App\Repository\InfoAutriceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InfoAutriceRepository.php';

        return $container->privates['App\\Repository\\InfoAutriceRepository'] = new \App\Repository\InfoAutriceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
