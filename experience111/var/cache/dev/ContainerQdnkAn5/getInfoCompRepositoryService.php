 ...
 */
class getInfoCompRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InfoCompRepository' shared autowired service.
     *
     * @return \App\Repository\InfoCompRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InfoCompRepository.php';

        return $container->privates['App\\Repository\\InfoCompRepository'] = new \App\Repository\InfoCompRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
