 ...
 */
class getDescRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DescRepository' shared autowired service.
     *
     * @return \App\Repository\DescRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DescRepository.php';

        return $container->privates['App\\Repository\\DescRepository'] = new \App\Repository\DescRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
